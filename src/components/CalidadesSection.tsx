  ...
  return (
    <section className="py-24 md:py-32 bg-sand">
      <div className="container max-w-6xl mx-auto px-6">
        ...
        >
          <motion.p variants={staggerItem} className="text-gold font-body text-sm tracking-[0.2em] uppercase mb-4">{t("calidades.tag")}</motion.p>
          ...
          {items.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-xl text-foreground mb-3 transition-colors duration-300 group-hover:text-accent">{item.title}</h3>
