                ...
                <nav className="space-y-2">
                  {navLinks.map((link, i) => (
                    ...
                    >
                      <Link
                        to={link.href}
                        className={`block font-display text-xl sm:text-2xl md:text-4xl py-2 leading-[1.6] break-words md:whitespace-nowrap transition-colors duration-300 nav-link ${
