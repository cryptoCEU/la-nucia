        ...
        <section ref={hero.ref} className="relative h-[92vh] min-h-[720px] flex items-end overflow-hidden">
          ...
          <motion.div className="relative z-10 container max-w-[1600px] mx-auto px-4 md:px-8 pb-20 pt-20" style={{ y: hero.textY, opacity: hero.opacity }}>
            <motion.div variants={staggerContainer(0.13, 0.3)} initial="hidden" animate="visible">
              ...
              <motion.h1 variants={heroText()} className="font-display text-4xl md:text-6xl lg:text-7xl text-primary-foreground leading-[1.6] mb-6 max-w-3xl">
          ...
          <div className="container max-w-6xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              <motion.div variants={staggerContainer(0.12)} initial="hidden" whileInView="visible" viewport={viewportOnce}>
                ...
                <motion.h2 variants={staggerItem} className="font-display text-3xl md:text-5xl text-foreground leading-[1.6] mb-8" dangerouslySetInnerHTML={{ __html: t(`${v}.conceptTitle`) }} />
        ...
        <section className="bg-primary py-24 md:py-32">
          <div className="container max-w-4xl mx-auto px-6 text-center">
            <motion.div variants={staggerContainer(0.1)} initial="hidden" whileInView="visible" viewport={viewportOnce}>
              ...
              <motion.h2 variants={staggerItem} className="font-display text-3xl md:text-5xl text-primary-foreground leading-[1.6] mb-4" dangerouslySetInnerHTML={{ __html: t(`${v}.ctaTitle`) }} />
