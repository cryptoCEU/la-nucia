  ...
  return (
    <>
      ...
      <div className="container max-w-3xl mx-auto px-6">
        <motion.div variants={fadeUp(0.2)} initial="hidden" animate="visible"><Link to="/" className="inline-flex items-center gap-2 text-primary hover:text-ocean-light font-body text-sm mb-10 transition-colors">
