            ...
            >
              <div className="container max-w-[1600px] mx-auto px-4 md:px-8">
                <div className="max-w-3xl">
                  ...
                  <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-primary-foreground leading-[1.6] mb-6">
                    {t("home.heroTitle1")}{" "}
          ...
          <div className="container max-w-6xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              >
                ...
                <motion.h2 variants={staggerItem} className="font-display text-3xl md:text-5xl text-foreground leading-[1.6] mb-8">
          ...
          <div className="relative z-10 container max-w-6xl mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              >
                ...
                <motion.h2 variants={staggerItem} className="font-display text-3xl md:text-5xl text-primary-foreground leading-[1.6] mb-8">
        ...
        <section className="py-28 md:py-40 bg-background">
          <div className="container max-w-[1600px] mx-auto px-4 md:px-8">
            ...
            >
              ...
              <motion.h2 variants={staggerItem} className="font-display text-3xl md:text-5xl text-foreground leading-[1.6] mb-6">
          ...
          <div className="container max-w-[1600px] mx-auto px-4 md:px-8">
            <div className="grid lg:grid-cols-[1fr_1.5fr] gap-16 items-center">
              ...
              >
                ...
                <motion.h2 variants={staggerItem} className="font-display text-2xl md:text-4xl text-foreground leading-[1.6] mb-8">
